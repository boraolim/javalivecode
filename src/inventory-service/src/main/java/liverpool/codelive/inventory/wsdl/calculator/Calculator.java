 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/D:/Codigo%20fuente/javalivecode/src/inventory-service/target/wsdl/calculator.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/Codigo%20fuente/javalivecode/src/inventory-service/target/wsdl/calculator.wsdl");
