...
public abstract class BaseTestData {
    ...
    protected EnrichedProductResponse responseFirstProduct;
    protected EnrichedProductResponse responseLastProduct;
    ...
    void setUpBase() throws Exception {
        ...
        responseFirstProduct = new EnrichedProductResponse();
        responseFirstProduct.setId(AppTestConstants.PRODUCT_FIRST_ID);
        responseFirstProduct.setName("PlayStation 5 Slim");
        responseFirstProduct.setDescription("Next-gen gaming console from Sony");
        responseFirstProduct.setPrice(new BigDecimal("499.99"));
        responseFirstProduct.setInventoryStatus(InventoryStatus.IN_STOCK);
        responseFirstProduct.setStock(100);
        ...
        responseLastProduct = new EnrichedProductResponse();
        responseLastProduct.setId("EXT-018");
        responseLastProduct.setName("Leche Alpura");
        responseLastProduct.setDescription("Leche Alpura de cuarto de litro con alta lactosa");
        responseLastProduct.setPrice(new BigDecimal("35.00"));
        responseLastProduct.setInventoryStatus(InventoryStatus.OUT_OF_STOCK);
        responseLastProduct.setStock(0);
