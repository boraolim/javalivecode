...
public final class AppConstants {   
    ...
    public static final String MSG_PRODUCT_ID_NOT_FOUND    = "El identificador %s no existe";
    public static final String MSG_PRODUCT_NOT_NULL        = "El inventario del producto no puede ser nulo.";
