...
### Topics and skills covered in this repository:
...
- REST APIs
- SOAP (connectivity with external services)
- Unit Testing (JUnit/Mockito)
- TDD
- Functional Programming
- Reactivate Programming
...
' Add your variable without the word "export", simply using NAME="Value". For example:
' JAVA_HOME="my_path_java"
' Save the changes with Ctrl + O, Enter, Ctrl + X and restart the active session or restart your computer.
```
...
```bash
// Enter the folder
$ cd src/code/src/common-utils
$ cd src/code/src/products-service
$ cd src/code/src/inventory-service
$ cd src/code/src/externalws-service
...
// Build ONLY one module (respecting its dependency on the already-installed parent)
$ mvn clean install -pl src/product-service -P local
